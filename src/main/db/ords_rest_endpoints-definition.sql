...
-- Schema: SCHALTSTELLE  Date: Sa Mai 23 12:26:29 2020 
--
...
');
  ...
  ORDS.DEFINE_TEMPLATE(
      p_module_name    => 'proposal',
      p_pattern        => 'setProposalStatus/:id',
      p_priority       => 0,
      p_etag_type      => 'HASH',
      p_etag_query     => NULL,
      p_comments       => NULL);
...
exception
  ...
  ORDS.DEFINE_HANDLER(
      ...
      p_source         => 
'begin
    update antrag set veto_start_date = :veto_start_date, proposal_status = :proposal_status
    where id = :id;
    :status := 200;
exception
    when others then
