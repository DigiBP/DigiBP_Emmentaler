...
CREATE UNIQUE INDEX  "ANTRAG_PK" ON  "ANTRAG" ("ID")
/
CREATE UNIQUE INDEX  "CHANGE_PK" ON  "CHANGE" ("ID")
/

 CREATE SEQUENCE   "SEQ_ANTRAG"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 101 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "SEQ_CHANGE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
